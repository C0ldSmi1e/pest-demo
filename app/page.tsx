...
const HomePage = () => {
  return (
    <div className="w-full flex flex-col items-center justify-center py-8">
      ...
      <div id="how-it-works" className="px-10 py-16 w-full flex flex-col items-center justify-center gap-y-24">
        <Steps />
      </div>
      <div id="about-us" className="px-10 py-16 w-full flex flex-col items-center justify-center gap-y-24">
        <Exhibit />
      </div>
