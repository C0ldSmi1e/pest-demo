...
const HomePage = () => {
  return (
    <div className="w-full flex flex-col items-center justify-center">
      ...
      <div id="how-it-works" className="px-10 py-16 w-full bg-color8 flex flex-col items-center justify-center gap-y-24">
        <Steps />
      </div>
      <div id="about-us" className="px-10 py-16 w-full flex flex-col items-center justify-center gap-y-24 bg-navy-900 text-white">
        <Exhibit />
      </div>
      ...
      <div id="faq" className="px-10 py-16 w-full flex flex-col items-center justify-center gap-y-24 bg-yellow-400">
        <FAQ />
      </div>
